...
<form class="form-horizental" method="POST" action="<?php echo Router::url('admin/posts/edit/'.$id); ?>">
  ...
  <?php echo $this->FormGen->input('created', 'Publication date', array('type'=>'date', 'class'=>'form-control')); ?>
	...
	<div class="form-group">
		<div class="col-sm-offset-5 col-sm-10">
			...
			<a class="btn btn-default" href="<?php echo Router::url('admin/posts/index'); ?>">Cancel</a>
		</div>
	</div>
</form>
